    ...
    public static void main(String[] args) {
        ...
        while (right < 5) {
            ...
            if (selected < 0 || selected > 99) {
                ...
                if (isWrong) {
                    right++;
                    System.out.println("Too much incorrect entry. Remaining right : " + (5 - right));
                } else {
                    isWrong = true;
                    System.out.println("If you make a wrong entry again, you will be deducted from your rights.");
                }
                continue;
            }
